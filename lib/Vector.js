class Vector {
  ...
  static up(vector) {
    if (vector) return Vector.copy(vector).up();
    return new Vector().up();
  }

  static down(vector) {
    if (vector) return Vector.copy(vector).down();
    return new Vector().down();
  }

  static left(vector) {
    if (vector) return Vector.copy(vector).left();
    return new Vector().left();
  }

  static right(vector) {
    if (vector) return Vector.copy(vector).right();
